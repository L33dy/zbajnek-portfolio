...
<div data-aos="fade-left" data-aos-once="true" data-aos-offset="350" class="w-full flex flex-col gap-3 font-degular">
    <div class="flex flex-col 2xl:gap-0.5">
        <h3 class="text-xl md:text-2xl 2xl:text-3xl font-semibold text-green-600">{expData.position}<span
